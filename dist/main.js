...
const domController = (function () {
    ...
    function projectComponents() {
        ...
        today.addEventListener('click', () => {
            console.log(_todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.giveMeAllTasksToday())
        })
    ...
    function renderProjectSelected() {
        ...
        let i = 0
        _todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.projects[currProject].todos.forEach((todo) => {
