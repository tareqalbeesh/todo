...
const domController = (function () {
    ...
    function projectComponents() {
        ...
        addProjectDialog.addEventListener("close", (value) => {
            if (addProjectDialog.returnValue != '')
                _todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.addProject(addProjectDialog.returnValue)
        })
    ...
    function addTodoDialogFun() {
        ...
        addTodoDialog.addEventListener("close", (value) => {
            ...
            if (addTodoDialog.returnValue != '') {
                ...
                _todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.addTodo(todoData.title, todoData.description, todoData.date, todoData.priority, currProject)
    ...
    function renederToday() {
        ...
        h1.innerText = "Today"
        //render tasks
        renderTasks(_todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.giveMeAllTasksToday())
    }
    function render7Days() {
        let h1 = document.querySelector('#title')
        h1.innerText = "Next 7 Days"
        //render tasks
        renderTasks(_todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.giveMeAllTasksNext7Days())
    }
    function renderProjectSelected() {
        console.log('changed project', _todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.projects[currProject])
        let h1 = document.querySelector('#title')
        h1.innerText = _todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.projects[currProject].name



        //render tasks
        renderTasks(_todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.projects[currProject].todos)
    ...
    function renderTasks(todos) {
        ...
        todos.forEach((todo) => {
            ...
            checkbox.addEventListener('change', () => {
                ...
                renderProjectSelected()
                _todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.saveState()
            ...
            dateSpan.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.format)(todo.dueDate, "P");

            todoItem.appendChild(checkbox)
            todoItem.appendChild(todoTextDiv)
            todoItem.appendChild(dateSpan)
            switch (todo.priority) {
                case _todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.Priority.LOW:
                    todoItem.style.borderBottom = "5px solid green"
                    break;
                case _todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.Priority.MEDIUM:
                    todoItem.style.borderBottom = "5px solid orange"
                    break;
                case _todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.Priority.HIGH:
    ...
    function renderThisTask(i) {
        ...
        let todoItems = document.querySelector("#todo-items")
        let todo = _todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.projects[currProject].todos[i];
        let todoItem = document.createElement('div')
        todoItem.classList = ['todo-item']
        todoItem.id = 'todo-' + i
        let checkbox = document.createElement('input')
    ...
    function addProjectDOM(projectName) {
        ...
        newProject.id = 'project-' + (_todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.projects.length - 1)
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   storageTasks: () => (/* binding */ storageTasks)
/* harmony export */ });
...
const storageTasks = (function () {
    function readAllProjectsFromStorage() {
        ...
        if (projectsFromStorage == null) {
            const inboxTODOs = new _todoManager__WEBPACK_IMPORTED_MODULE_0__.Project('inbox')
            let task1 = new _todoManager__WEBPACK_IMPORTED_MODULE_0__.TODO('Buy Milk', 'Buy milk from Netto', new Date(), _todoManager__WEBPACK_IMPORTED_MODULE_0__.Priority.LOW, inboxTODOs)
            let task2 = new _todoManager__WEBPACK_IMPORTED_MODULE_0__.TODO('Add Read.me File', 'a good idea would be to stop procrastination and just do it', new Date(), undefined, inboxTODOs)
            let task3 = new _todoManager__WEBPACK_IMPORTED_MODULE_0__.TODO('Add editing the tasks functionality', 'another day of dealing with html dialogs', new Date(), _todoManager__WEBPACK_IMPORTED_MODULE_0__.Priority.HIGH, inboxTODOs)
            ...
            projects = JSON.parse(projectsFromStorage, (key, value) => {
                ...
                return value;
            }).map(projectJson => _todoManager__WEBPACK_IMPORTED_MODULE_0__.Project.fromJSON(projectJson));
...
/* harmony export */ });
/* harmony import */ var _dom_control_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom-control.js */ "./src/dom-control.js");
...
const todoLogic = (function () {
    ...
    function addProject(projectName) {
        ...
        _dom_control_js__WEBPACK_IMPORTED_MODULE_0__.domController.addProjectDOM(projectName)
        _storage_js__WEBPACK_IMPORTED_MODULE_1__.storageTasks.saveState(projects)
    }
    function addTodo(title, description, dueDate, priority, projectId) {
        ...
        _dom_control_js__WEBPACK_IMPORTED_MODULE_0__.domController.renderThisTask(projects[projectId].todos.length - 1)
        _storage_js__WEBPACK_IMPORTED_MODULE_1__.storageTasks.saveState(projects)
    }
    ...
    function init() {
        ...
        projects = _storage_js__WEBPACK_IMPORTED_MODULE_1__.storageTasks.readAllProjectsFromStorage()
    ...
    function renderProjectsList() {
        projects.forEach((project) => {
            if (project.name != 'inbox') {
                _dom_control_js__WEBPACK_IMPORTED_MODULE_0__.domController.addProjectDOM(project.name)
            }
        })
    }
    function saveState() {
...
_dom_control_js__WEBPACK_IMPORTED_MODULE_0__.domController.changeProject(0)
...
//testing da stuff
// let todo = new TODO('title1', 'd', undefined, undefined)
// let project1 = new Project("project1")
// project1.todos.push(todo)
// console.log(project1)
// domController.displayTODOs(project1.todos, document.querySelector('p'))
