...
const domController = (function () {
  ...
  function projectComponents () {
    ...
    addProjectDialog.addEventListener('close', (value) => {
      if (addProjectDialog.returnValue !== '') { _todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.addProject(addProjectDialog.returnValue) }
    })
  ...
  function renderThisTask (i) {
    const todoItems = document.querySelector('#todo-items')
    const todo = _todoManager_js__WEBPACK_IMPORTED_MODULE_0__.todoLogic.projects[currProject].todos[i]
    const todoItem = document.createElement('div')
    todoItem.classList = ['todo-item']
    todoItem.id = 'todo-' + i
    const checkbox = document.createElement('input')
...
const storageTasks = (function () {
  function readAllProjectsFromStorage () {
    ...
    if (projectsFromStorage == null) {
      ...
      const task1 = new _todoManager__WEBPACK_IMPORTED_MODULE_0__.TODO('Buy Milk', 'Buy milk from Netto', new Date(), _todoManager__WEBPACK_IMPORTED_MODULE_0__.Priority.LOW, inboxTODOs)
      const task2 = new _todoManager__WEBPACK_IMPORTED_MODULE_0__.TODO('Add Read.me File', 'add a cool read.me ', new Date(), undefined, inboxTODOs)
      const task3 = new _todoManager__WEBPACK_IMPORTED_MODULE_0__.TODO('Add editing the tasks functionality', 'another day of dealing with html dialogs', new Date(), _todoManager__WEBPACK_IMPORTED_MODULE_0__.Priority.HIGH, inboxTODOs)
...
class TODO {
  ...
  static fromJSON = function (json, project) {
    const todo = new TODO(json.title, json.description, new Date(json.dueDate), json.priority, project)
    todo.done = json.done
    return todo
  }
...
const todoLogic = (function () {
  ...
  function addTodo (title, description, dueDate, priority, projectId) {
    const todo = new TODO(title, description, dueDate, priority, projects[projectId])
