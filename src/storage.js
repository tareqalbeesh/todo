import { TODO, Project, Priority } from './todoManager'
const storageTasks = (function () {
  function readAllProjectsFromStorage () {
    ...
    if (projectsFromStorage == null) {
      ...
      const task1 = new TODO('Buy Milk', 'Buy milk from Netto', new Date(), Priority.LOW, inboxTODOs)
      const task2 = new TODO('Add Read.me File', 'add a cool read.me ', new Date(), undefined, inboxTODOs)
      const task3 = new TODO('Add editing the tasks functionality', 'another day of dealing with html dialogs', new Date(), Priority.HIGH, inboxTODOs)
